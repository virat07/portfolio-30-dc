...
export default defineConfig(({ mode }) => {
  ...
  return {
    define: {
      "process.env.REACT_APP_OPEN_AI_KEY": JSON.stringify(
        env.REACT_APP_OPEN_AI_KEY
      ),
      ...
      "process.env.REACT_APP_OPEN_AI_KEYREACT_APP_FIREBASE_DATABASE_URL":
        JSON.stringify(
          env.REACT_APP_OPEN_AI_KEYREACT_APP_FIREBASE_DATABASE_URL
        ),
